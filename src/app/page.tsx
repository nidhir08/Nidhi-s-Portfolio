...
export default function Portfolio() {
  ...
  <span className="relative z-10 flex items-center">
    ...
    <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
      ...
      {/* About Section */}
      <section id="about" className="py-32 relative sm:px-20 px-4">
        <div className="absolute inset-0 z-0">
      ...
      {/* Skills Section */}
      <section id="skills" className="py-32 relative sm:px-20 px-4">
        <div className="absolute inset-0 z-0">
      ...
      {/* Projects Section */}
      <section id="projects" className="py-32 relative sm:px-20 px-4">
        <div className="absolute inset-0 z-0">
      ...
      {/* Experience Section */}
      <section id="experience" className="py-32 relative sm:px-20 px-4">
        <div className="absolute inset-0 z-0">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-32 relative sm:px-20 px-4">
        <div className="absolute inset-0 z-0">
